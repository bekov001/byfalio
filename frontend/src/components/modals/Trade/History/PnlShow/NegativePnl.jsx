...
export default function NegativePnl({pnlPercentage, positionType, pnlProfit ,settings, leverage, openPrice, ticker, currentPrice}) {
  return (
                        ...
                        <div className="trade_pnl_slide_row">
                            <div className="trade_pnl_slide_row_left">
                                ...
                                <div className="trade_pnl_slide_row_pnl">
                                    <span>ROI</span>
                                    <p className='color_red'>{pnlPercentage}%</p>
                                </div>
                        ...
                        <div className="trade_pnl_slide_row">
                            <div className="trade_pnl_slide_row_left">
                                ...
                                <div className="trade_pnl_slide_row_pnl">
                                    ...
                                    <p className='color_red'>{pnlProfit}</p>
                                </div>
                                <div className="trade_pnl_slide_row_price">
                                    <div className="trade_pnl_slide_row_price_column">
                                        <span>Цена входа</span>
