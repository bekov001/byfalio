        ...
        <header>
            ...
            <div className="header_coin">
                <div className="header_coin_change_w">
                    <div className={tokenSearch==true ? "header_coin_change header_coin_change_active" : "header_coin_change"} onClick={()=>setTokenSearch(!tokenSearch)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M3.5 14.99H20.5" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M3.5 9.00999L8.51 3.98999" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M20.5 9.01001H3.5" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                ...
                <div className="header_coin_price">
                    <span>{tokenPrice ?  tokenPrice : 28000}</span>
                    <p>≈29,190.40 USDT</p>
                </div>
                <div className="header_coin_price_row">
                    <div className="header_coin_price_item">
                        <p>Изм. за 24 ч</p>
                        <span className="color_red">-0.22%</span>
                    </div>
                    <div className="header_coin_price_item">
                        <p>Макс. за 24 ч</p>
                        <span>28,490.40%</span>
            ...
            <div className="header_btns">
                ...
                <div className="hbp header_btn_notice" onClick={()=>setNotificationShow(!notificationShow)}>
                    <svg className={(notificationShow) ? "hbp_btn hbp_btn_active" : "hbp_btn"} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M10.2598 21H13.3898" stroke="#5E6367" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </g>
                        <defs>
                ...
                <div className="hbp header_btn_change_theme">
                    <img className="hbp_btn" src="img/change_theme_sun.svg" alt=""/>
                </div>
            </div>
